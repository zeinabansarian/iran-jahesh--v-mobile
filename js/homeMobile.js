...
//  title slider
let swiperTitle = new Swiper('.swiper-Title',{
    speed: 1000,
    slidesPerView:1,
    spaceBetween: 40,
    grabCursor:true,
  })
  swiper.controller.control = swiperTitle;
  swiperTitle.controller.control = swiper;
let swiperService = new Swiper('.swiper-services', {
    // Optional parameters
    slidesPerView: 1,
    spaceBetween: 30,
    grabCursor:true,
